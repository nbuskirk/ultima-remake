      ...
      for (i = _i = 0, _ref = yCount * xCount; _i < _ref; i = _i += 1) {
        ...
        if (tsProperties) {
          if (tsProperties[tNum - 1]) {
			...
			if (tsProperties[tNum - 1]["description"]) {
				 description = tsProperties[tNum - 1]["description"];
            }
			if(tsProperties[tNum - 1]["interactionSprite"]){
				isprite = tsProperties[tNum - 1]["interactionSprite"];
			}
          }
        }		
        Crafty.c(tName, {
          comp: components,
		  desc: description,
          interactionSprite: isprite,
		  init: function() {
            this.addComponent(this.comp);
			this._description = this.desc;
            return this;
          }
        });
        tNum++;
